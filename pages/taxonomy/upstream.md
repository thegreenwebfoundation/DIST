...
<p class="my-4">{% include DIST/categoryItem.html item="CatUSoftware" %}</p>
...
{% include DIST/categoryItem.html item="CatUNetworkHardware" %}
...
{% include DIST/categoryItem.html item="CatUContentData" %}
...
**Next:** [Operational Impacts](/taxonomy/operational)
