...
<p>The DIST taxonomy is a standardised categorisation system for structuring impact estimates data across the whole digital life-cycle. It can be applied across multiple environment impact dimensions, although carbon is the most fully formed as present. Water, health and critical minerals are coming soon.</p>
