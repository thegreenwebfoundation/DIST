...
<div class="prose">
<p class="mt-8">You can also explore all the full data set.<p>
<p class="button"><a href="https://docs.getgrist.com/dtnqVUgecwdJ/DIST-Methodologies-Map?utm_id=share-doc">View full Methodologies Map in table form</a></p>

<p>Or download the entire content of the Methodologies Map in <a href="https://api.getgrist.com/o/docs/api/docs/dtnqVUgecwdJQSmwBaGqJo/download/csv?viewSection=1&tableId=Methodologies_Map">.csv format</a> and <a href="https://api.getgrist.com/o/docs/api/docs/dtnqVUgecwdJQSmwBaGqJo/download/xlsx?viewSection=7&tableId=Methodologies_Map"> .xlsx format</a>.</p>
...
<p class="bold">Do you own or work on a methods that help people estimate the impact from their digital tech? We would like to hear from you.</p>
